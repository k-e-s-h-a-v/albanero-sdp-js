...
// calculates how many dots exist in a pentagonal shape around 
// the center dot on the Nth iteration.

// In the image below you can see the first iteration is only a single dot. 
// On the second, there are 6 dots. On the third, there are 16 dots, 
...
let pentagonal = n => n==1 ? 1 : 5 * (n-1) + pentagonal(n - 1);
